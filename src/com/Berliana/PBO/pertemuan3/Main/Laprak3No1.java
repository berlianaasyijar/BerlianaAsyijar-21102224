//package com.Berliana.PBO.pertemuan3.Main;
//
//import java.util.Scanner;
//
//public class Laprak3No1 {
...
//            bk1.setPengarang("Indrajani"); bk1.setTahun_Terbit(2007);
//            bk1.setHarga(70000);
//            bk2.setNo_Buku(2);
...
//                        = input.nextInt(); if (bayar <= totalHarga){
//                    clearScreen();
//                    System.out.println("Mohon maaf uang anda tidak
//                            cukup.");
//                }else {
//                    clearScreen();
...
//                bayar = input.nextInt(); if (bayar <= totalHarga){
//                    System.out.println("Mohon maaf uang anda tidak
//                            cukup.");
//                }else {
//                    System.out.println("=== Rincian Pembayaran ===");
